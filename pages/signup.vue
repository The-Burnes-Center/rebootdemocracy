    ...
    >
      <div id="mc_embed_signup_scroll">
        ...
        <div class="mc-field-group">
          ...
          <input type="text" name="FNAME" class="text" id="mce-FNAME" v-model="firstName">
        </div>
        <div class="mc-field-group">
          <label for="mce-LNAME">Last Name </label>
          <input type="text" name="LNAME" class="text" id="mce-LNAME" v-model="lastName">
        </div>
        <div class="mc-field-group">
          <label for="mce-MMERGE5">Affiliation </label>
          <input type="text" name="MMERGE5" class="text" id="mce-MMERGE5" v-model="affiliation">
        </div>
