...
// netlify/functions/openai-report-directus.mjs
var openai_report_directus_exports = {};
__export(openai_report_directus_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(openai_report_directus_exports);
...
// netlify/functions/openai-report-directus.mjs
var REPORT_DIRECTUS_URL = process.env.REPORT_DIRECTUS_URL;
var REPORT_DIRECTUS_TOKEN = process.env.REPORT_DIRECTUS_TOKEN;
async function handler(event) {
  ...
  try {
    ...
    const payload = {
      ...
      openid_id: openaiId || null
      // Set only for OpenAI messages
    };
...
*/
//# sourceMappingURL=openai-report-directus.js.map
