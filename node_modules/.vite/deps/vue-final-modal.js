...
function ao(e, o) {
  ...
  async function M() {
    n.value = true, await nextTick(), l.value = true, p.value = true;
  }
  function P() {
    l.value = false, p.value = false;
  }
  return {
    visible: n,
    contentVisible: l,
...
function uo(e, o, t) {
  const { vfmRootEl: s, vfmContentEl: d, visible: a, modelValueLocal: r } = t, n = ref();
  function l() {
    a.value && e.escToClose && (r.value = false);
  }
  function u(p) {
  ...
  function h2() {
    var p;
    n.value === s.value && (e.clickToClose ? r.value = false : ((p = d.value) == null || p.focus(), o("clickOutside")));
  }
  return {
    onEsc: l,
    onMouseupRoot: h2,
...
function fo(e, o) {
  ...
  const { focusEl: t } = o, { hasFocus: s, activate: d, deactivate: a } = useFocusTrap(t, e.focusTrap);
  function r() {
...
var po = (e, o) => !(e.scrollTop === 0 && o < 0 || e.scrollTop + e.clientHeight + o >= e.scrollHeight && o > 0);
var mo = (e) => {
  const o = [];
  for (; e; ) {
...
var bo = (e) => e ? e.scrollHeight - e.scrollTop <= e.clientHeight : false;
var To = (e, o) => (ee = e.targetTouches[0].clientY - He, Ne(e.target) ? false : o && o.scrollTop === 0 && ee > 0 || bo(o) && ee < 0 ? se(e) : (e.stopPropagation(), true));
var Mo = (e, o) => {
  if (!e) {
    console.error(
  ...
  }, le || (document.addEventListener("touchmove", se, he ? { passive: false } : void 0), le = true)) : ho(o);
};
var So = (e) => {
  if (!e) {
    console.error(
  ...
  N = N.filter((o) => o.targetElement !== e), xe ? (e.ontouchstart = null, e.ontouchmove = null, le && N.length === 0 && (document.removeEventListener("touchmove", se, he ? { passive: false } : void 0), le = false)) : N.length || wo();
};
function Oo(e, o) {
...
function ko(e, {
  ...
  const r = reactive({ x: 0, y: 0 }), n = reactive({ x: 0, y: 0 }), l = computed(() => r.x - n.x), u = computed(() => r.y - n.y), { max: h2, abs: p } = Math, S = computed(
    () => h2(p(l.value), p(u.value)) >= o
  ), b = ref(false), g = computed(() => S.value ? p(l.value) > p(u.value) ? l.value > 0 ? "left" : "right" : u.value > 0 ? "up" : "down" : "none"), k = (c, y) => {
    r.x = c, r.y = y;
  }, E = (c, y) => {
    n.x = c, n.y = y;
  };
  ...
  function T(c) {
    ...
    k(y, R), E(y, R), t == null || t(c), P = [
      useEventListener(e, "mousemove", F, M),
      useEventListener(e, "touchmove", F, M),
      useEventListener(e, "mouseup", i, M),
      useEventListener(e, "touchend", i, M),
      useEventListener(e, "touchcancel", i, M)
    ];
  }
  function F(c) {
    const { x: y, y: R } = Ie(c);
    E(y, R), !b.value && S.value && (b.value = true), b.value && (s == null || s(c));
  }
  function i(c) {
    b.value && (d == null || d(c, g.value)), b.value = false, P.forEach((y) => y());
  }
  let m = [];
  return onMounted(() => {
    const c = Vo(window == null ? void 0 : window.document);
    a ? M = c ? { passive: true } : { capture: false } : M = c ? { passive: false, capture: true } : { capture: true }, m = [
      useEventListener(e, "mousedown", T, M),
      useEventListener(e, "touchstart", T, M)
    ];
  }), {
    isSwiping: b,
    direction: g,
...
function Eo(e, o) {
  ...
  const { lengthX: g, lengthY: k, direction: E, isSwiping: M } = ko(n, {
    ...
    onSwipeEnd(i, m) {
      ...
      const B = new Date().getTime(), c = m === e.swipeToClose, y = (() => {
        var K, j;
        if (m === "up" || m === "down")
...
var Bo = defineComponent({
  ...
  setup(e, { emit: o }) {
    const t = e, s = o, { modals: d, openedModals: a } = inject(we, {
      ...
      deleteFromOpenedModalOverlays: h2,
      deleteFromModals: p
    } = inject(be, {
      openLastOverlay: D,
      ...
      deleteFromModals: D
    }), S = ref(), b = ref(), { focus: g, blur: k } = fo(t, { focusEl: S }), { zIndex: E, refreshZIndex: M, resetZIndex: P } = go(t), { modelValueLocal: T } = co(t, s), { enableBodyScroll: F, disableBodyScroll: i } = Oo(t, {
      lockScrollEl: S,
      modelValueLocal: T
    }), { emitEvent: m } = Co(s);
    let B = D;
    ...
    } = Eo(t, { vfmContentEl: b, modelValueLocal: T }), Se = toRef(t, "hideOverlay"), A = computed(() => ({
      modalId: t.modalId,
      hideOverlay: Se,
      overlayVisible: j,
      focus: g,
    ...
    const ie = computed(() => a.indexOf(A));
    watch(() => [t.zIndexFn, ie.value], () => {
      c.value && M(ie.value);
    }), onMounted(() => {
      d.push(A);
    }), T.value && Oe(), watch(T, (f) => {
      f ? Oe() : Ke();
    });
    async function Oe() {
    ...
    function Ke() {
      m("beforeClose"), h2(A), r(), k(), ze();
    }
    return onBeforeUnmount(() => {
      F(), p(A), l(A), h2(A), k(), r();
    }), (f, w) => f.displayDirective !== "if" || unref(c) ? withDirectives((openBlock(), createElementBlock("div", {
      key: 0,
      ref_key: "vfmRootEl",
      ref: S,
      class: normalizeClass(["vfm vfm--fixed vfm--inset", { "vfm--prevent-none": f.background === "interactive" }]),
      style: normalizeStyle({ zIndex: unref(E) }),
      role: "dialog",
      "aria-modal": "true",
      onKeydown: w[7] || (w[7] = withKeys(() => unref(Ge)(), ["esc"])),
      onMouseup: w[8] || (w[8] = withModifiers(() => unref(Ue)(), ["self"])),
      onMousedown: w[9] || (w[9] = withModifiers((O) => unref(Te)(O), ["self"]))
    }, [
      Se.value ? createCommentVNode("", true) : (openBlock(), createBlock(Transition, mergeProps({ key: 0 }, unref(Ye), { appear: true }, toHandlers(unref(je))), {
        default: withCtx(() => [
      ...
      createVNode(Transition, mergeProps(unref(K), { appear: true }, toHandlers(unref(R))), {
        default: withCtx(() => [
          f.displayDirective !== "if" || unref(y) ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            key: 0,
            ...
            f.showSwipeBanner ? (openBlock(), createElementBlock("div", {
              ...
              onTouchstart: w[2] || (w[2] = (O) => unref(Me)(O))
            }, [
              ...
              key: 1,
              class: "vfm-swipe-banner-container",
              onTouchstart: w[5] || (w[5] = (O) => unref(Me)(O))
            }, [
              createBaseVNode("div", {
                class: "vfm-swipe-banner-back",
            ...
            [vShow, f.displayDirective !== "show" || unref(y)],
            [unref(ce), f.displayDirective !== "visible" || unref(y)]
          ]) : createCommentVNode("", true)
        ]),
        _: 3
      }, 16)
    ], 38)), [
      [vShow, f.displayDirective !== "show" || unref(c)],
      [unref(ce), f.displayDirective !== "visible" || unref(c)]
    ]) : createCommentVNode("", true);
  }
});
var Lo = {
...
var Do = defineComponent({
  ...
  setup(e, { emit: o }) {
    ...
    return (a, r) => (openBlock(), createBlock(Teleport, {
      to: a.teleportTo ? a.teleportTo : void 0,
      disabled: !a.teleportTo
    }, [
      createVNode(Bo, normalizeProps(guardReactiveProps(unref(d))), {
        default: withCtx(() => [
...
var H;
var Po = (e) => H = e;
var Ao = () => getCurrentInstance() && inject(we) || H;
function Go() {
  const e = shallowReactive([]), o = shallowReactive([]), t = shallowReactive([]), s = shallowReactive([]), d = ref([]), a = markRaw({
    install(r) {
    ...
    open(r) {
      return a.toggle(r, true);
    },
    close(r) {
      return a.toggle(r, false);
    },
    closeAll() {
...
function Uo(e) {
  ...
  async function t() {
    let l;
    return H ? l = H : (await nextTick(), l = oe()), o.modelValue ? Promise.resolve("[Vue Final Modal] modal is already opened.") : (n(), o.modelValue = true, l.dynamicModals.push(o), new Promise((u) => {
  ...
  function d(l) {
    const { slots: u, ...h2 } = De(l, o.component);
    l.defaultModelValue !== void 0 && (o.defaultModelValue = l.defaultModelValue), (l == null ? void 0 : l.keepAlive) !== void 0 && (o.keepAlive = l == null ? void 0 : l.keepAlive), a(o, h2), u && Object.entries(u).forEach(([p, S]) => {
      const b = o.slots[p];
  ...
  function r(l, u) {
    return Object.entries(u).forEach(([h2, p]) => {
      l[h2] = p;
    }), l;
  }
  function n() {
...
function No(e) {
  const { props: o, modalProps: t, emit: s } = e, d = computed(() => xo(o, t)), a = Ho(s), r = useAttrs();
  return computed(() => ({
    ...d.value,
    ...a,
    ...r
...
var Xo = defineComponent({
  ...
  setup(e) {
    const o = oe(), t = Ro(), s = Symbol("ModalsContainer"), d = computed(() => {
      var a;
    ...
    return o.modalsContainers.value.push(s), onBeforeUnmount(() => {
    ...
    }), (a, r) => d.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(o).dynamicModals, (n, l) => (openBlock(), createBlock(resolveDynamicComponent(n.component), mergeProps({
      key: n.id
    }, {
      ...
      onClosed: () => {
        var u, h2;
        return (h2 = (u = unref(t)).resolvedClosed) == null ? void 0 : h2.call(u, l);
      },
      onOpened: () => {
        var u, h2;
        return (h2 = (u = unref(t)).resolvedOpened) == null ? void 0 : h2.call(u, l);
      }
    }), createSlots({ _: 2 }, [
      renderList(n.slots, (u, h2) => ({
        name: h2,
        fn: withCtx(() => [
          unref(me)(u) ? (openBlock(), createElementBlock("div", {
            key: 0,
            innerHTML: u
          }, null, 8, jo)) : "component" in u ? (openBlock(), createBlock(resolveDynamicComponent(u.component), normalizeProps(mergeProps({ key: 1 }, u.attrs)), null, 16)) : (openBlock(), createBlock(resolveDynamicComponent(u), { key: 2 }))
        ])
      }))
